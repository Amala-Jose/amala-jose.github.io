...
export const lab = [
  {
    ...
    stack: ["JS"],
    links: [
      { label: "Link", href: "https://codesandbox.io/p/sandbox/counter-with-n-and-n-1-8p44d8" },
    ],
  },
  {
    id: "use-debounce",
    ...
    stack: ["React"],
    links: [
      { label: "Link", href: "https://codesandbox.io/p/sandbox/debounce-w5lndx" },
    ],
  },
  {
    id: "stopwatch-laps",
    ...
    stack: ["React"],
    links: [{ label: "Link", href: "https://codesandbox.io/p/sandbox/stop-watch-lap-fd3cn2" }],
  },
];
